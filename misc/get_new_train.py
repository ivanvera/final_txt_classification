...
Util.save_object_into_pkl(result2, FilePathConfig.file_root_path + "result_total.pkl")
Util.save_object_into_pkl(result, FilePathConfig.file_root_path + "result_perfect.pkl")
